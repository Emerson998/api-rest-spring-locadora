...
public class LocadoraDto {
	...
	public LocadoraDto(String nome, String endereco, String lote, Long quantidadeDeDvds, String cnpj, LocalDate data) {
		this.nome = nome;
	...
	public String toString() {
		return "LocadoraDto [nome=" + nome + ", endereco=" + endereco + ", lote=" + lote + ", quantidadeDeDvds="
